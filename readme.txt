...
Version 1.1.4 vom 18.02.2009

 * Bugfix: Behebung eines UTF-8 Fehlers mit den Schlagworten (Tags) und Keywords

Version 1.2 vom 02.03.2009

 * Bugfix: Fehler in Speicherfunktion fuer die META-Daten eines Artikels
 * Bugfix: Fehlerbehebung bei den Einstellung fuer die Daten von All In One Seo Pack
 * Change: Umfangreiches Refacturing mit Code und Performanceoptimierung
 * Add: Atom-Feed mit noindex moeglich
 * Remove: Suche in der Dokumentation entfernt
 * Remove: Log-System entfernt
 * Remove: Fehleranzeige entfernt
 * Remove: Unterstuetzung von SimpleTags, Simpletagging und Ultimate Tag Warrior entfernt

Version 1.2.1 vom 03.03.2009
