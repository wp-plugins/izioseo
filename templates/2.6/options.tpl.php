		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_title]" id="izioseo_title" style="width:325px;" value="<?php echo $data['izioseo_title'] ?> " />
						<div style="text-align:justify;">
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_keywords]" id="izioseo_keywords" style="width:325px;" value="<?php echo $data['izioseo_keywords'] ?>" />
						<div style="text-align:justify;">
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="izioseo[izioseo_analytics_tracking_id]" id="izioseo_analytics_tracking_id" style="width:170px;" value="<?php echo $data['izioseo_analytics_tracking_id'] ?>" />
						<div style="text-align:justify;">
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_wptools]" id="izioseo_wptools" style="width:325px;" value="<?php echo $data['izioseo_wptools'] ?>" />
						<div style="text-align:justify;">
		...
		<table class="form-table">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_title_post]" id="izioseo_format_title_post" style="width:325px;" value="<?php echo $data['izioseo_format_title_post'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_format_title_post" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_title_page]" id="izioseo_format_title_page" style="width:325px;" value="<?php echo $data['izioseo_format_title_page'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_format_title_page" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
								<li><b>%blog_title%</b> - <?php _e('Titel des gesamten Blogs', 'izioseo') ?></li>
								<li><b>%blog_description%</b> - <?php _e('Beschreibung aus dem Wordpress Blog', 'izioseo') ?></li>
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_title_search]" id="izioseo_format_title_search" style="width:325px;" value="<?php echo $data['izioseo_format_title_search'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_format_title_search" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
								<li><b>%blog_title%</b> - <?php _e('Titel des gesamten Blogs', 'izioseo') ?></li>
								<li><b>%blog_description%</b> - <?php _e('Beschreibung aus dem Wordpress Blog', 'izioseo') ?></li>
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_title_category]" id="izioseo_format_title_category" style="width:325px;" value="<?php echo $data['izioseo_format_title_category'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_format_title_category" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
								<li><b>%blog_title%</b> - <?php _e('Titel des gesamten Blogs', 'izioseo') ?></li>
								<li><b>%blog_description%</b> - <?php _e('Beschreibung aus dem Wordpress Blog', 'izioseo') ?></li>
								<li><b>%category_title%</b> - <?php _e('Name der Kategorie', 'izioseo') ?></li>
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_title_paged]" id="izioseo_format_title_paged" style="width:325px;" value="<?php echo $data['izioseo_format_title_paged'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_format_title_paged" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_title_tag]" id="izioseo_format_title_tag" style="width:325px;" value="<?php echo $data['izioseo_format_title_tag'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_format_title_tag" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
								<li><b>%blog_title%</b> - <?php _e('Titel des gesamten Blogs', 'izioseo') ?></li>
								<li><b>%blog_description%</b> - <?php _e('Beschreibung aus dem Wordpress Blog', 'izioseo') ?></li>
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_title_archive]" id="izioseo_format_title_archive" style="width:325px;" value="<?php echo $data['izioseo_format_title_archive'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_format_title_archive" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
								<li><b>%blog_title%</b> - <?php _e('Titel des gesamten Blogs', 'izioseo') ?></li>
								<li><b>%blog_description%</b> - <?php _e('Beschreibung aus dem Wordpress Blog', 'izioseo') ?></li>
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_title_404]" id="izioseo_format_title_404" style="width:325px;" value="<?php echo $data['izioseo_format_title_404'] ?>" />
						<div style="max-width: 750px; text-align: left; width: 100%">
							...
							<ul id="placeholder_izioseo_format_title_404" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
								<li><b>%blog_title%</b> - <?php _e('Titel des gesamten Blogs', 'izioseo') ?></li>
								<li><b>%blog_description%</b> - <?php _e('Beschreibung aus dem Wordpress Blog', 'izioseo') ?></li>
		...
		<table class="form-table">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_format_description]" id="izioseo_format_description" style="width:325px;" value="<?php echo $data['izioseo_format_description'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_format_description" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="izioseo[izioseo_image_alt]" id="izioseo_image_alt" style="width:325px;" value="<?php echo $data['izioseo_image_alt'] ?>" />
						<div style="text-align:justify;">
							...
							<ul id="placeholder_izioseo_image_alt" style="padding-left:10px; list-style-image: none; list-style-type: none; display:none;">
								<li><b>%blog_title%</b> - <?php _e('Titel des gesamten Blogs', 'izioseo') ?></li>
								<li><b>%post_title%</b> - <?php _e('Titel des Blogbeitrages', 'izioseo') ?></li>
								<li><b>%post_author_login%</b> - <?php _e('Loginname des Autors', 'izioseo') ?></li>
								<li><b>%post_author_nicename%</b> - <?php _e('Benutzername des Autors', 'izioseo') ?></li>
