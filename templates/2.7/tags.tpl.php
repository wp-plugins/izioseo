			...
			<div id="postcustomstuff">
				<table id="list-table">
					...
					<tbody class="list:meta" id="the-list">
						<tr class="alternate">
							<td class="left" style="padding:2px 8px;"><label for="izioseo_post_disable"><?= $this->helpButton('META-Daten verwenden') ?> <? _e('META-Tags benutzen:', 'izioseo')?></label></td>
						...
						<tr class="alternate">
							<td class="left" style="padding:2px 8px;"><label for="izioseo_post_title"><?= $this->helpButton('Seitentitel') ?> <? _e('Seitentitel:', 'izioseo') ?></label></td>
							<td><input type="text" name="izioseo[izioseo_post_title]" id="izioseo_post_title" value="<?= $data['title'] ?>" /></td>
						</tr>
						<tr class="alternate">
							<td class="left" style="padding:2px 8px;"><label for="izioseo_post_description"><?= $this->helpButton('META-Beschreibung') ?> <? _e('META-Beschreibung:', 'izioseo') ?></label></td>
							<td><textarea name="izioseo[izioseo_post_description]" id="izioseo_post_description" style="height:100px;"><?= $data['description'] ?></textarea></td>
						</tr>
						<tr class="alternate">
							<td class="left" style="padding:2px 8px;"><label for="izioseo_post_keywords"><?= $this->helpButton('META-Keywords') ?> <? _e('META-Keywords:<br />(durch Kommas getrennt)', 'izioseo') ?></label></td>
							<td><input type="text" name="izioseo[izioseo_post_keywords]" id="izioseo_post_keywords" value="<?= $data['keywords'] ?>" /></td>
						</tr>
						<tr class="alternate">
							<td class="left" style="padding:2px 8px;"><label for="izioseo_post_robots"><?= $this->helpButton('META-Robots') ?> <? _e('META-Robots:', 'izioseo') ?></label></td>
							<td>
						...
						<tr class="alternate">
							<td class="left" style="padding:2px 8px;"><?= $this->helpButton('Verhalten bei keinen META-Daten') ?> <label for="izioseo_post_use"><? _e('Verwendung:<br />(bei keinen META-Daten)', 'izioseo') ?></label></td>
							<td>
				...
				<table id="list-table">
					...
					<tbody class="list:meta" id="the-list">
						<tr class="alternate">
							<td class="left" style="padding:2px 8px;"><?= $this->helpButton('Google AdSection') ?> <label for="izioseo_post_google_adsection"><? _e('Google AdSection verwenden:', 'izioseo')?></label></td>
						...
						<tr class="alternate">
							<td class="left" style="padding:2px 8px;"><?= $this->helpButton('Suchmaschinenfreundliche Bilder') ?> <label for="izioseo_post_image_use"><? _e('Bilder optimieren:', 'izioseo')?></label></td>
						...
						<tr class="alternate">
							<td class="left" style="padding:2px 8px; vertical-align:top;"><?= $this->helpButton('Suchmaschinenfreundliche Bilder') ?> <label for="izioseo_post_image_alt"><? _e('Formatierung des &lt;img ... alt="..." /&gt;-Tags', 'izioseo')?></label></td>
							<td>
								<input type="text" name="izioseo[izioseo_post_image_alt]" id="izioseo_post_image_alt" value="<?= $data['seo_image_alt'] ?>" />
